  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/4e1b9fea-ef4e-4d1f-89e2-54574e221934/files/f391ea44-23ed-4f0b-9852-53fb4395c394.jpg"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Профессиональный автосервис"}</p>
          ...
          >
            {"Ремонт авто"}
            <br />
            <span className="text-orange-200">{"которому доверяют"}</span>
          </h1>
        </div>
      </div>
